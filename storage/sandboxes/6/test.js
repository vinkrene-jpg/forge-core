...
if (m.name !== 'real-code-execution-test-runner') { console.error('FAIL: manifest name'); process.exit(1); }
...
console.log('self-check passed for real-code-execution-test-runner');
